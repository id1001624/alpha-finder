...
call :ensure_logon_autostart "%ENGINE_TASK%" "%BASE_DIR%\run_intraday_execution_engine.bat" %ENGINE_DELAY% "%ENGINE_STARTUP_FILE%"
...
echo - %ENGINE_TASK% 使用者登入後 %ENGINE_DELAY% 啟動，若排程權限不足則改寫入 Startup
