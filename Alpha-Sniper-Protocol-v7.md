...
你在回答最後必須至少輸出「一個 CSV 檔案內容」：

1. `FILE: ai_decision_YYYY-MM-DD.csv`
2. `FILE: ai_decision_YYYY-MM-DD.md`（選填）
...
1. `# AI Decision Daily Report (YYYY-MM-DD)`
2. `## Data Status`
3. `## Top Picks Summary`
4. `## Theme Notes`
5. `## Risk Flags`
...
3. 若有輸出 MD，再輸出 `FILE: ai_decision_YYYY-MM-DD.md` 的完整 Markdown 區塊
